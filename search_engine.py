...
class SearchEngine:
    def __init__(self,dataset, node_dir_prefix=None,embed_model_name='BAAI/bge-m3'):# nvidia/NV-Embed-v2 "vidore/colqwen2-v0.1"
        ...
        if 'vidore' in embed_model_name or 'openbmb' in embed_model_name:
            ...
            self.vector_embed_model = HuggingFaceEmbedding(model_name=self.embed_model_name, embed_batch_size=1, max_length=512, trust_remote_code=True, device='cuda:0', revision="3fa59658547db50a1e8e3346cf057fd0c77ed6ef" if self.embed_model_name == "nvidia/NV-Embed-v2" else None)
        self.recall_num = 100
